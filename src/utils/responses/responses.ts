 ...
 */
export const ok = (res: Response, data?: any): any => {
  const payload: ResponsePayload = formatResponse(200)
 ...
 */
export const created = (res: Response, data?: any): any => {
  const payload: ResponsePayload = formatResponse(201)
 ...
 */
export const badRequest = (res: Response, message?: any): any => {
 ...
 */
export const unauthorized = (res: Response, message?: any): any => {
 ...
 */
export const forbidden = (res: Response, message?: any): any => {
 ...
 */
export const notFound = (res: Response, message?: any): any => {
 ...
 */
export const methodNotAllowed = (res: Response, message?: any): any => {
 ...
 */
export const conflict = (res: Response, message?: any): any => {
 ...
 */
export const gone = (res: Response, message?: any): any => {
 ...
 */
export const internalServerError = (res: Response, message?: any): any => {
 ...
 */
export const notImplemented = (res: Response, message?: any): any => {
 ...
 */
export const badGateway = (res: Response, message?: any): any => {
 ...
 */
export const serviceUnavailable = (res: Response, message?: any): any => {
 ...
 */
export const gatewayTimeout = (res: Response, message?: any): any => {
 ...
 */
export const networkAuthenticationRequired = (res: Response, message?: any): any => {
